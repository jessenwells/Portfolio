        ...
        jqbar: function (options) {
            ...
            return this.each(function () {
                ...
                if (settings.orientation == 'h') {
                    ...
                    progressContainer.addClass('jqbar horizontal').append('<div class="meterinfo"><span class="bar-percent"></span><span class="bar-label"></span></div><span class="bar-level-wrapper"><span class="bar-level"></span></span>');
