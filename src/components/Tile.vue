<template lang="pug">
div
  router-link(:to="details.link" event='' @mouseover.native='go')
...
export default {
  ...
  mounted() {
    ...
    function enter() {
      ...
      path.animate(
        { d: "M25.5,319c0,0,74-7,150-7s150,7,150,7" },
        800,
        mina.bounce
      );
      frame.animate(
    ...
    function leave() {
      ...
      path.animate(
        { d: "M25.5,319c0,0,74,0,150,0s150,0,150,0" },
        1200,
        mina.elastic
      );
      frame.animate(
        {
          d:
            "M334,175v154c0,2.8-2.2,5-5,5H175H21c-2.8,0-5-2.2-5-5V175V21c0-2.8,2.2-5,5-5h154h154c2.8,0,5,2.2,5,5V175z M350,0H175H0v175v175h175h175V175V0L350,0L350,0z"
        },
        1200,
        mina.elastic
      );
  ...
  methods: {
    go: function() {
      let hoverClick = event.target.parentElement;
      setTimeout(() => {
        hoverClick.onclick = () => {
          setTimeout(() => {
