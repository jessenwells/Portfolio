...
data() {
  return {
    ...
    synopsis: 'T-shirt Graphic designed for silkscreen printing created for Fashion Planet. Showing Manhattan neighborhoods in a hand drawn typographical layout.',
    image: {
      path1: '/assets/apparel/nycmap/01.jpg',
